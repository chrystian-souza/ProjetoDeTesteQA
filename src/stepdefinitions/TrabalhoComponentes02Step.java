...
public class TrabalhoComponentes02Step {
    ...
    public void que_o_usuário_entrou_na_página_Campo_de_Treinamento() {
        componentes.inicializarComponentesHtml();
    }
    ...
    @Dado("que o usuário digitou Olsen")
    public void que_o_usuário_digitou_Olsen() {
    ...
    public void clicar_em_Entrar() {
        ...
        componentes.entrarSiteEmpresa();

    }

    @Então("deve apresentar o site da empresa Olsen")
    public void deve_apresentar_o_site_da_empresa_Olsen() {
        componentes.validarSiteEmpresa();
    }
